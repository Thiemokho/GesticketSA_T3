...
<?php
           ...
           $query = $pdo->query("SELECT * FROM `planification` ");
           $apps= $query->fetchAll();
          // var_dump($users) ;
...
<html lang="en">
  <head>
    <title>Liste plannifications</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <div class="container-fluid h-100">
    <div class="row h-100">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu3" aria-expanded="false">
                        <ul class="flex-column pl-2 nav">
                            ...
                            <li class="nav-item"><a class="nav-link py-0 text-secondary " href="listePlanif.php">Listes des planifications</a></li>
                            <li class="nav-item">
                                <div class="collapse small" id="submenu1sub1" aria-expanded="false">
        ...
        <div class="col pt-2" style='background:url("img/bg1.jpg"); background-size:cover;'>
         ...
         <h2 class="text-center text-primary">LISTE DES PLANIFICATIONS</h2>
         <div class="row ">
               <div class="col"></div>
  ...
  <thead >
    <tr>
      ...
      <th scope="col" class="text-primary">Menu1</th>
      <th scope="col" class="text-primary">Menu2</th>
      <th scope="col" class="text-primary">Menu3</th>
      <th scope="col" class="text-primary">Menu4</th>
      <th scope="col" class="text-primary">Menu5</th>
  ...
  <?php 
                ...
                ?>
    <tr>
                <td><?php echo $ap['Jour_planif'];?></td>
                <td><?php echo $ap['Menu1'];?></td>
                <td><?php echo $ap['Menu2'];?></td>
                <td><?php echo $ap['Menu3'];?></td>
                <td><?php echo $ap['Menu4'];?></td>
                <td><?php echo $ap['Menu5'];?></td>
            

             <td style="width: 30%;">
              
                  <a href="form_ap.php?id=<?php echo $ap['id']; ?>"><i class="fa fa-pencil" style="font-size:30px;margin-right:-20px;"></i></a>
                  <a href=""><i class="fa fa-trash" style="font-size:30px; position: relative;left: 50px;"></i> </a>
