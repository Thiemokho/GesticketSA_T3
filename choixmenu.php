...
<?php
           ...
           $query = $pdo->query("SELECT * FROM `choix` ");
           $apps= $query->fetchAll();
          // var_dump($users) ;
...
<html lang="en">
  ...
  <div class="container-fluid h-100">
    <div class="row h-100">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="submenu4" aria-expanded="false">
                        <ul class="flex-column pl-2 nav">
                            ...
                            <li class="nav-item"><a class="nav-link py-0 text-secondary " href="listeA">Listes des apprenant</a></li>
                            <li class="nav-item">
                                <div class="collapse small" id="submenu1sub1" aria-expanded="false">
        ...
        <div class="col pt-2" style='background:url("img/bg1.jpg"); background-size:cover;'>
         ...
         <h2 class="text-center text-primary">LISTE DES CHOIX</h2>
  ...
  <thead >
    <tr>
      <th scope="col" class="text-primary">Nom du plat</th>
      <th scope="col" class="text-primary">Jour</th>
      <th scope="col" class="text-primary">Apprenant</th>
